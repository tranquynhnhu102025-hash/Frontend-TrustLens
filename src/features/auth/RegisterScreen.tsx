  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[75vh] px-4">
      <div className="bg-white dark:bg-zinc-950 p-8 rounded-xl border border-zinc-200 dark:border-zinc-900 w-full max-w-sm shadow-sm">
        ...
        {error && (
          <div className="flex items-center gap-2 p-3 mb-4 text-xs font-semibold text-red-600 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/50 rounded-lg">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <button 
            ...
            className="w-full py-2.5 mt-2 font-bold text-white bg-zinc-900 hover:bg-zinc-850 dark:bg-white dark:hover:bg-zinc-100 dark:text-black rounded-lg transition-colors flex justify-center items-center gap-1.5 shadow-sm text-xs disabled:opacity-50"
          >
